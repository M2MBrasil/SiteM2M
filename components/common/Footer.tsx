...
export function Footer({ onOpenLogin, setCurrentView, onNavigate, onRequestQuote }: FooterProps) {
  ...
  return (
    <footer className="w-full bg-slate-950 border-t border-blue-900/40 text-slate-300">
      ...
      <div className="border-b border-blue-900/30 bg-gradient-to-r from-blue-950/40 via-slate-900/60 to-blue-950/40 py-8 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-900/50 border border-blue-900/30">
            ...
            <div>
              <p className="font-semibold text-sm text-white">Entrega para Todo o Brasil</p>
          ...
          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-900/50 border border-blue-900/30">
            ...
            <div>
              <p className="font-semibold text-sm text-white">Alta Durabilidade</p>
          ...
          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-900/50 border border-blue-900/30">
            ...
            <div>
              <p className="font-semibold text-sm text-white">Aprovação de Arte</p>
          ...
          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-900/50 border border-blue-900/30">
            ...
            <div>
              <p className="font-semibold text-sm text-white">Pagamento Facilitado</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              {settings.logoUrl ? (
                <div className="h-10 max-w-[140px] flex items-center justify-center p-1 rounded-xl bg-slate-900 border border-blue-900/50">
                ...
                <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-500 to-slate-900 flex items-center justify-center text-white font-black text-lg border border-blue-400/40">
                  M2M
                </div>
              )}
              <span className="font-bold text-lg text-white">{settings.companyName || 'M2MBrasil'}</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold text-sm text-white mb-4 uppercase tracking-wider text-blue-300">
              Departamentos
            </h4>
        ...
        <div className="mt-12 pt-6 border-t border-slate-900 text-xs text-slate-500 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© 2026 M2MBrasil Produtos Personalizados. Todos os direitos reservados.</p>
